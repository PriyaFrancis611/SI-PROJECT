...
def profile_edit(request):
    ...
    if request.method == "POST":
        ...
        details.upload_image = request.POST['upload_image']
        details.save()
    ...
    if request.method == "POST":
        ...
        if password == confirm_password:
            if User.objects.filter(username=username).exists():
                ...
                if request.POST['gender'] is None and request.POST['contact_no'] is None and request.POST[
                    'Dateofbirth'] is None and request.POST['country'] is None and request.POST['state'] is None and \
                        request.POST['city'] is None and request.POST['hobbies'] is None and request.POST[
                    'upload_image']:
                    ...
                    details.upload_avatar = request.FILES['upload_image']
...
def forgot_password(request):
    if request.method == "POST":
        ...
        # return redirect('change_password')
        messages.success(request,'email sent succesfull')
